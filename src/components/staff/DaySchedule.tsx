import { CheckCircle2, Clock, Play, AlertTriangle, MapPin } from "lucide-react";
        ...
        <div className="space-y-2">
          {assignments.map((a, i) => {
            ...
            return (
              <div
                key={a.id}
                className={`task-card flex items-start gap-3 ${
              ...
              >
                ...
                <div className="flex flex-col items-center pt-1">
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center ${config.className}`}
                  >
                    {config.icon}
                  </div>
